...
class Matnaninsungba(Player):
    ...
    def __init__(self):
        super().__init__('맛난인성봐',"assets/player/cat.png", 1000, 1000)

    def stun(self, fight_data: FightData, additional_data: Entity):
    ...
    skills = [
        ...
        Skill('Matnaninsungba_atk2', '냥냥 방어', '폭탄들 던져 1명에게 공격력 만큼의 데미지를 준다.', "assets/player/no_img.png", attack, Need.Enemy)
    ]
